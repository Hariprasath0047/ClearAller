...
def search_products(base_url: str, query: str, page_size: int = 24, page_count: int = 6) -> list[dict[str, Any]]:
        ...
        try:
            response = requests.get(
                ...
                params={
                    ...
                    "page_size": page_size,
                    "page": page,
                    "fields": "code,product_name,product_name_en,ingredients_text,ingredients_text_en,brands,image_front_url,image_url,countries,countries_tags",
                },
                timeout=20,
            )
...
def search_fda_descriptions(query: str, limit: int = 20) -> list[str]:
    try:
        response = requests.get(
